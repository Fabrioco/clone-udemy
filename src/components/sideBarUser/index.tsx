...
export const SidebarUser: React.FC<SidebarUserProps> = ({
  ...
  return (
    <div
      ...
      } w-[500px] h-full bg-white border-l border-gray-400 p-5 transition-all flex flex-col justify-between`}
    >
      ...
      <div className="w-full">
        ...
        <div className="border border-gray-400 w-full h-20 rounded-md flex flex-row justify-around items-center">
          ...
          <div className="text-xl font-secondary flex justify-between w-1/2">
            <p>5</p>
